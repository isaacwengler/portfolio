...
const createDemo = (src) => {
    return `<video class="img4" alt="Project Demo" autoplay controls>
            <source src="${src}" type="video/mp4">
            </video>`;
}

const replaceWithDemo = (element, src) => {
    const demoHtml = createDemo(src);
    document.getElementById(element).innerHTML = demoHtml;
}